...
void __cdecl hooks::cl_move::function(float accumulated_extra_samples, bool final_tick) {
	...
	auto allowed_ticks = config->m_misc.m_reduce_input_delay ? 21 : (ctx->m_local_weapon->m_item_definition_index() == Scout_m_ForceANature ||
		ctx->m_local_weapon->m_item_definition_index() == Scout_m_FestiveForceANature) ? 22 : 23;
